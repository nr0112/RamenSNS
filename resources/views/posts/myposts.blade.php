        ...
        @foreach($posts as $post)
            <div class="post-content">
                <a class="post-link" href="{{ route('posts.detail', ['post_id'=>$post->id])}}">
                    <img class="post-photo img-thumbnail" src="{{ secure_asset('storage/photos/'.$post->filename) }}" alt="投稿した画像">
                    <div class="post-info">
                        <img class="info-user-image" src="{{ secure_asset('storage/user_images/'.$post->user->user_image) }}">
